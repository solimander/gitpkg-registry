...
var abi__namespace$1 = /*#__PURE__*/_interopNamespace(abi$2);
var routerAbi__namespace = /*#__PURE__*/_interopNamespace(routerAbi);
var abi__namespace$2 = /*#__PURE__*/_interopNamespace(abi$3);
var abi__namespace$4 = /*#__PURE__*/_interopNamespace(abi$5);
var abi__namespace$3 = /*#__PURE__*/_interopNamespace(abi$4);
var abi__namespace = /*#__PURE__*/_interopNamespace(abi);
...
const isCryptoPunk = address => {
  return (address == null ? void 0 : address.toLowerCase()) === constants.CRYPTOPUNKS;
};
const isCryptoKitty = address => {
  return (address == null ? void 0 : address.toLowerCase()) === constants.CRYPTOKITTIES;
};
...
const isStakeOrMint = (mint, network) => {
  ...
  if (((_mint$user = mint.user) == null ? void 0 : (_mint$user$id = _mint$user.id) == null ? void 0 : _mint$user$id.toLowerCase()) === getChainConstant(constants.NFTX_STAKING_ZAP, network).toLowerCase()) {
    // LP Stake
    return 'stake';
  }
...
const isVaultEnabled = vault => {
  ...
  if (vault.asset.id.toLowerCase() === constants.OPENSEA_COLLECTION.toLowerCase() && !((_vault$eligibilityMod = vault.eligibilityModule) != null && _vault$eligibilityMod.id)) {
    return false;
  }
...
exports.fetch0xPrice = fetch0xPrice$3;
